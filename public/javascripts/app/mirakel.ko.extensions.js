...
ko.bindingHandlers.animatedVisible = {
    ...
    update: function (element, valueAccessor, allBindingsAccessor, viewModel) {
        var value =  valueAccessor();
        if(mirakel.isMobile) { //no animations for mobile
            $(element).toggle(value);
        } else {
            if (value) {
                TweenMax.fromTo(element, 1,
                    {rotationY: -90, transformOrigin: "0% 50% 0", autoAlpha: 0},
                    {rotationY: 0, transformOrigin: "0% 50% 0", autoAlpha: 1,
                        onStart: function () {
                ...
                TweenMax.fromTo(element, 1,
                    {rotationY: 0, transformOrigin: "0% 50% 0", autoAlpha: 1},
                    {rotationY: 128, transformOrigin: "0% 50% 0", autoAlpha: 0,
                        onStart: function () {
...
(function() {
     ...
     * The choice is made based on existence of _id property
